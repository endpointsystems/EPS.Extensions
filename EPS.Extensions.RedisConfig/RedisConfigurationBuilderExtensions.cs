...
public static class RedisConfigurationBuilderExtensions
{
    ...
    extension(IConfigurationBuilder builder)
    {
        ...
        public IConfigurationBuilder AddRedisConfiguration(string connectionString,
        ...
        /// <returns>The <see cref="IConfigurationBuilder"/>.</returns>
        public IConfigurationBuilder AddRedisConfigurationWithPolling(string connectionString,
            string configurationKey,
        ...
        /// <returns>The <see cref="IConfigurationBuilder"/>.</returns>
        public IConfigurationBuilder AddRedisConfigurationWithPubSub(string connectionString,
            string configurationKey,
        ...
        /// <returns>The <see cref="IConfigurationBuilder"/>.</returns>
        public IConfigurationBuilder AddRedisConfiguration(Action<RedisConfigurationOptions> configureOptions)
        {
        ...
        /// <summary>
        /// Adds a Redis configuration source using RedisJSON module for storage.
        /// Requires the RedisJSON module to be installed on the Redis server.
        /// </summary>
        /// <param name="connectionString">The Redis connection string.</param>
        /// <param name="configurationKey">The Redis key containing the configuration JSON. Default is "app:configuration".</param>
        /// <returns>The <see cref="IConfigurationBuilder"/>.</returns>
        public IConfigurationBuilder AddRedisJsonConfiguration(string connectionString,
            string configurationKey = "app:configuration")
        {
            return builder.AddRedisConfiguration(options =>
            {
        ...
        /// <summary>
        /// Adds a Redis configuration source using RedisJSON module with polling-based reload.
        /// Requires the RedisJSON module to be installed on the Redis server.
        /// </summary>
        /// <param name="connectionString">The Redis connection string.</param>
        /// <param name="configurationKey">The Redis key containing the configuration JSON.</param>
        /// <param name="pollingInterval">The interval at which to poll for configuration changes.</param>
        /// <returns>The <see cref="IConfigurationBuilder"/>.</returns>
        public IConfigurationBuilder AddRedisJsonConfigurationWithPolling(string connectionString,
            string configurationKey,
            TimeSpan pollingInterval)
        {
            return builder.AddRedisConfiguration(options =>
        ...
        /// <summary>
        /// Adds a Redis configuration source using RedisJSON module with Pub/Sub-based reload.
        /// Requires the RedisJSON module to be installed on the Redis server.
        /// </summary>
        /// <param name="connectionString">The Redis connection string.</param>
        /// <param name="configurationKey">The Redis key containing the configuration JSON.</param>
        /// <param name="pubSubChannel">The Redis Pub/Sub channel for change notifications. Default is "app:configuration:changed".</param>
        /// <returns>The <see cref="IConfigurationBuilder"/>.</returns>
        public IConfigurationBuilder AddRedisJsonConfigurationWithPubSub(string connectionString,
            string configurationKey,
            string pubSubChannel = "app:configuration:changed")
        {
            return builder.AddRedisConfiguration(options =>
