...
public class Unique
{
    ...
    /// <summary>
    /// Generates a random string consisting of uppercase letters only.
    /// </summary>
    /// <param name="length">The length of the generated string. Must be greater than 0.</param>
    /// <returns>A randomly generated string consisting of uppercase letters.</returns>
    ...
    /// <summary>
    /// Generates a random string consisting of lowercase letters only.
    /// </summary>
    /// <param name="length">The length of the generated string. Must be greater than 0.</param>
    /// <returns>A randomly generated string consisting of lowercase letters.</returns>
    ...
    /// <summary>
    /// Generates a random string of specified length with a specified number of non-alphanumeric characters.
    /// </summary>
    /// <param name="length">The length of the generated string. Must be between 1 and 128.</param>
    /// <param name="numberOfNonAlphanumericCharacters">The number of non-alphanumeric characters allowed in the generated string.</param>
    ...
    public static string Generate(int length, int numberOfNonAlphanumericCharacters)
    {
        ...
        for (var iter = 0; iter < length; iter++)
        {
            ...
            if (i > 127 || BadPunctuation.FirstOrDefault(bp => bp == i) > 0 )
            {
            ...
            if (nacNo < numberOfNonAlphanumericCharacters ||
