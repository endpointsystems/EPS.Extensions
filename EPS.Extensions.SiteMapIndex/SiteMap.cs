...
public class SiteMap
{
    ...
    /// </summary>
    /// <param name="siteMapPath">The full URL to the site map.</param>
    /// <param name="stayCompliant">Checks to make sure you're staying within limits if true.</param>
    ...
    /// <summary>
    /// Quick load of pages into <see cref="Locations"/>.
    /// </summary>
    /// <param name="pages"></param>
    public void Load(List<string> pages)
    {
        var ll = new LocationBuilder(SiteMapPath.GetLeftPart(UriPartial.Authority));
        foreach (var page in pages)
        {
            Locations.Push(ll.Build(page));
        }
    }
